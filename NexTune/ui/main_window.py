...
class GameOptimizerWindow(tk.Tk):
    ...
    def _build_header(self):
        ...
        for w in (self.lbl_time, self.lbl_mahm, self.lbl_nvml, self.lbl_ab):
    ...
    def _build_tab_bar(self):
        ...
        rows = [
            ...
            [TAB_DEFS[1], TAB_DEFS[3], TAB_DEFS[5]],   # Optimizer, Stress, Settings
        ]
    ...
    def _open_startup_mgr(self):
        ...
        sp.Popen(["powershell.exe", "-WindowStyle", "Hidden",
                  "-Command", "Start-Process msconfig -Verb RunAs"],
